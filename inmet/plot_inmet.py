...
ax2.set_title("Área %s" % metareas['Area'][area], loc = 'left')
...
ax3.set_title("Área %s" % metareas['Area'][area], loc = 'left')
ax.set_box_aspect(1)
...
ax4.set_title("Área %s" % metareas['Area'][area], loc = 'left')
...
ax5.set_title("Área %s" % metareas['Area'][area], loc = 'left')
