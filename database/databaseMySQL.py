...
def consulta_dados(table, query):
    """Short summary.

    Parameters
    ----------
    query : string
        Query a ser executada para retornar os dados.

    Returns
    -------
    dataframe
        Dataframe com os dados requeridos.
    ...
    if cnx.is_connected():
        ...
        query_cols = "SHOW COLUMNS FROM %s;" % table
        ...
        dados_df = pd.DataFrame(dados, columns = name_cols)
